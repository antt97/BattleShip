...
#line 16 "..\\main.c"
	...
	void SYS_Init(void)
	{
		...
		CLK_SetModuleClock(((((1) & 0x03) << 30)|(((16) & 0x1f) << 0)| (((1) & 0x03) << 28)|(((3) & 0x07) << 25)|(((24) & 0x1f) << 20)| (((0) & 0x03) << 18)|(((0x0F) & 0xff) << 10)|(((8) & 0x1f) << 5)), (0x0UL<<24), (((1)-1) << 8));
			...
			CLK_SetModuleClock(((((1) & 0x03) << 30)|(((3) & 0x1f) << 0) | (((1) & 0x03) << 28)|(((7) & 0x07) << 25)|(((12) & 0x1f) << 20)| (((0x0) & 0x03) << 18)|(((0x0) & 0xff) << 10)|(((0x0) & 0x1f) << 5)), (0x0UL<<16), 0);
		...
		((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPB_MFP |= ((1UL<<0) | (1UL<<1)
			...
			((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPA_MFP |= (
											(1UL<<3) | (1UL<<2)
						  );
	...
	void quetphim_Init(volatile uint32_t ** output,volatile uint32_t ** input)
	{
			...
			input[0] = &(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((10)<<2))));
			input[1] = &(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((11)<<2))));
			input[2]=	&(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((15)<<2))));
			input[3]=	&(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(4))) + ((5)<<2))));
		
			output[0] = &(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(1))) + ((11)<<2))));
			output[1] = &(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((14)<<2))));
			output[2]=	&(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((13)<<2))));
			output[3]=	&(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((12)<<2))));
	}
	unsigned char quetphim(volatile uint32_t ** output,volatile uint32_t ** input)
	{
			...
			(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((13)<<2)))) = 0;
			(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((12)<<2)))) = 0;		
			TIMER_Delay(((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)), 2);
					...
					for(int i = 0;i<4;i++)
					{
						...
						for(int j = 0;j<4;j++)
						{
							if(*input[j]==0)
							{
								...
								while(*input[j]==0);
								int u32DelayTime = TIMER_GetCounter(((TIMER_T *) ((( uint32_t)0x40000000) + 0x10020))) / 1000;
								if(u32DelayTime < 100)
									return 'a';
								return KEYS_PAD[i][j];
							}
	...
	void UART3_Init()
	{
		...
		UART_Open(((UART_T *) ((( uint32_t)0x40000000) + 0x54000)), 115200);
	}
