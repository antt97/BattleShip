	...
	int32_t press(char key){		
		...
		g_OK = TRUE;		
		if(key == '1')
			sendATcmd("GET /game/press?userName=device1&key=1 HTTP/1.1\r\nHost: totienan.tk\r\n\r\n");		
		else if(key == '2')
			sendATcmd("GET /game/press?userName=device1&key=8 HTTP/1.1\r\nHost: totienan.tk\r\n\r\n");		
		else if(key == '3')
			sendATcmd("GET /game/press?userName=device1&key=3 HTTP/1.1\r\nHost: totienan.tk\r\n\r\n");		
		else if(key == '4')
			sendATcmd("GET /game/press?userName=device1&key=4 HTTP/1.1\r\nHost: totienan.tk\r\n\r\n");		
		else if(key == '5')
			sendATcmd("GET /game/press?userName=device1&key=5 HTTP/1.1\r\nHost: totienan.tk\r\n\r\n");		
		else if(key == '6')
			sendATcmd("GET /game/press?userName=device1&key=6 HTTP/1.1\r\nHost: totienan.tk\r\n\r\n");		
		else if(key == '8')
			sendATcmd("GET /game/press?userName=device1&key=2 HTTP/1.1\r\nHost: totienan.tk\r\n\r\n");		
		while(g_OK);	
	}
	int32_t main(void)
	{
